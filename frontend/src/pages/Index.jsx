          ...
          <div className="w-[350px] bg-[#323335] m-auto px-6 py-4 rounded-md relative">
            ...
            {type === "signin" && (
              <form>
                ...
                <div>
                  <button className="px-3 py-2 rounded-md bg-purple-500 w-full outline-none hover:bg-purple-800 text-white">
                    Sign in
                  </button>
                </div>
                ...
                <div>
                  <button className="px-3 flex justify-center items-center gap-2 py-2 rounded-md bg-blue-600 w-full text-white outline-none hover:bg-blue-800">
                    <span>
                      <FaFacebookF />
                    </span>
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex gap-4">
                ...
                <button
                  ...
                  className="py-2 w-[80px] text-center bg-purple-500 text-white transition-all hover:bg-purple-800 rounded-[5px] font-medium"
                >
                  Sign up
                </button>
              </div>
        ...
        <div className="w-full h-full justify-center items-center p-4">
          <div className="py-[168px] flex justify-center items-center flex-col gap-6">
            ...
            <button
              ...
              className="py-2 w-[200px] text-center bg-purple-500 text-white transition-all hover:bg-purple-800 rounded-[5px] font-medium"
            >
              Signup for free
            </button>
          </div>
